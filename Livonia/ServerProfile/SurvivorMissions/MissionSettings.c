...
#include "$CurrentDir:\\mpmissions\\Expansion.EnochGloom\\SurvivorMissionModule\\EventsWorldData.c"
#include "$CurrentDir:\\mpmissions\\Expansion.EnochGloom\\SurvivorMissionModule\\Missions\\Missions.h"
...
{	
	...
	static string ZoneEnterMsg = "Sie haben die Missionszone betreten!";
	static string TimeLeftMsg = "Minuten bis zum Ende der Mission.";	//keep first character as space
	static string ZoneLeaveMsg = "Sie haben die Missionszone verlassen!";	
	static string StartingMsg = "Kann mich jemand hören? Kommen!";	//(Message 0)
	static string TargetFoundMsg = "Sie haben das Ziel gefunden!";
